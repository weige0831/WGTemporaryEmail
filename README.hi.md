...
### लॉग और डिस्क की स्वचालित सफ़ाई

- मेल डेटा: समाप्त पते स्वतः हटते हैं, कुल मात्रा `max_storage_mb` (डिफ़ॉल्ट 1GB) से सीमित - सबसे पुराने पहले
- कंटेनर लॉग: हर सेवा 10MB × 3 फ़ाइलों में रोटेट होती है (प्रति कंटेनर अधिकतम 30MB)
- बिल्ड कैश: `docker system prune` + `docker builder prune` साप्ताहिक (cron)
- apt कैश: `apt-get autoclean` मासिक (cron)
- journald 200MB तक सीमित; उपरोक्त सब `setup.sh` स्वतः कॉन्फ़िगर करता है
